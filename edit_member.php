...
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
	...
	<div class="container mt-5">
		<div class="row sidebar">
			...
			<?php $select = mysqli_query($koneksi, "SELECT `no_induk`,`nama`,`status`,`last_login`, `kata_sandi` FROM `peminjam` WHERE `no_induk` = '".$_GET['no_induk']."' UNION SELECT `no_induk`,`nama`,`status`,`last_login`, `kata_sandi` FROM `staff_pengelola` WHERE `no_induk` = '".$_GET['no_induk']."'");
			?>
			<?php
			...
			?>
				...
				<div class="form-group my-3 w-50">
					...
					<input name="kata_sandi" type="text" class="form-control" required="required" value="<?php echo $baris['kata_sandi']; ?>">
				</div>
