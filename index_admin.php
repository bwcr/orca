	...
	<section class="col-lg-4 col-12 px-0 shadow">
		...
		<div class="card-body py-3" style="background-color: #EFEFEF;" id="form">
			<?php if (isset($_SESSION['errors'])): ?>
				...
				<form role="form" method="POST" action="proses_masuk_admin.php">
					<div class="form-group my-3">
						<label for="no_induk">Username</label>
						<input type="text" name="no_induk" class="form-control" placeholder="Username" id="no_induk" required="required">
					</div>
					<div class="form-group my-3">
